...
namespace MyWMS.Helpers
{
    ...
    public sealed class CurrencyToChineseConverter : IValueConverter
    {
        private readonly string[] numberP = new string[] { "零", "壹", "贰", "叁", "肆", "伍", "陆", "柒", "捌", "玖",//9
            "", "拾", "佰", "仟",//13
            "", "万", "亿"};//16
        private readonly string[] unitP = new string[] { "整", "元", "角", "分" };
